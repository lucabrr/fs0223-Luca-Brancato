...
for (i = 0; i < starWarsCharacters.length; i++) { characters.push(starWarsCharacters[i].name) }
...
for (let a = 0; a < starWarsCharacters.length; a++) {
  if (starWarsCharacters[a].gender == "female") { femaleCharacters.push(starWarsCharacters[a]) }
...
for (let q = 0; q < starWarsCharacters.length; q++) {
  switch (starWarsCharacters[q].eye_color) {
    case "blue":
      eyeColor.blue.push(starWarsCharacters[q])

      break;
    case "yellow":
      eyeColor.yellow.push(starWarsCharacters[q])

      break;
    case "brown":
      eyeColor.brown.push(starWarsCharacters[q])

      break;
    case "red":
      eyeColor.red.push(starWarsCharacters[q])

      break;
    case "blue-gray":
      eyeColor["blue-gray"].push(starWarsCharacters[q])
...
while (x < starWarsCharacters.length) {
  massaTotale = massaTotale + parseInt(starWarsCharacters[x].mass);
  x++;
}
...
for (let z = 0; z < starWarsCharacters.length; z++) {
  if (starWarsCharacters[z].gender == "n/a") { starWarsCharacters[z].gender = "robot" }
}
...
for (let k = 0; k < characters.length; k++) {
  if (characters[k] == femaleCharacters[0].name 
    ||characters[k] == femaleCharacters[1].name )
        {
