const whoWins:Function = function(p1:number,p2:number){
    ...
    if(numeroCasuale === p1){
        ...
        let differenzaP1:number = Math.abs(numeroCasuale - p1)
        console.log("differenzaP1",differenzaP1);
        let differenzaP2:number = Math.abs(numeroCasuale - p2)
        console.log("differenzaP2",differenzaP2);
        
        if(differenzaP1 < differenzaP2){return `P1 si è avvicinato di più a ${numeroCasuale}` }
            else if (differenzaP2 < differenzaP1 ){return `P2 si è avvicinato di più a ${numeroCasuale}`}
